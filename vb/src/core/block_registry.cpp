...
void vb::Blocks::registerBlocks() {
    ...
    vb::Blocks::registerBlock(vb::Block("dirt", vb::BlockRenderType::OPAQUE, 0.3f), vb::Blocks::ByID::DIRT, TextureRegion(0,0,64,64));
    vb::Blocks::registerBlock(vb::Block("grass", vb::BlockRenderType::OPAQUE, 0.5f), vb::Blocks::ByID::GRASS, TextureRegion(0,0,64,64));
    vb::Blocks::registerBlock(vb::Block("stone", vb::BlockRenderType::OPAQUE, 1.0f), vb::Blocks::ByID::STONE, TextureRegion(0,0,64,64));
}